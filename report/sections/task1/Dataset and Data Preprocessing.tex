...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/task1/data_visualization.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.32\textwidth]{figures/task1/training_report_aug_0.08_loss_only.png}
    \hfill
    \includegraphics[width=0.32\textwidth]{figures/task1/training_report_aug_0.1_loss_only.png}
    \hfill
    \includegraphics[width=0.32\textwidth]{figures/task1/training_report_aug_0.12_loss_only.png}
