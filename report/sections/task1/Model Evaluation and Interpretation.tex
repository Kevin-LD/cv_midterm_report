...
Figure~\ref{fig:confusion_matrix_1} presents the confusion matrix on the test set. Most classes are classified accurately, while several visually similar breeds exhibit noticeable confusion.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/task1/confusion_matrix.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/task1/error_example.png}
