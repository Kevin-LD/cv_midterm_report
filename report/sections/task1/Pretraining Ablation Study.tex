...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/task1/W&B Chart ablation train loss.png}
    \hfil
    \includegraphics[width=0.45\textwidth]{figures/task1/W&B Chart ablation val acc.png}
