...
Meanwhile, all images and masks are resized to a fixed spatial resolution of $256 \times 256$. The RGB images are converted into tensors and normalized using the ImageNet mean and standard deviation:
\[
